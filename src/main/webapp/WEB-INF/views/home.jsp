      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            ...
            <b class="text-faded mb-4" style="font-family: ヒラギノ角ゴ Pro W3, Hiragino Kaku Gothic Pro, Osaka, メイリオ, Meiryo, ＭＳ Ｐゴシック, MS PGothic, sans-serif; font-size: 25px">
            	H5の<span style="color: yellow;">palatte</span>は特別なあなたの
           	</b><br>
           	<b class="text-faded mb-4" style="font-family: ヒラギノ角ゴ Pro W3, Hiragino Kaku Gothic Pro, Osaka, メイリオ, Meiryo, ＭＳ Ｐゴシック, MS PGothic, sans-serif; font-size: 25px">
           		もっと特別に表現する方法を提示してくれます。
           	</b><br><br>
            <b class="text-faded mb-4" style="font-family: ヒラギノ角ゴ Pro W3, Hiragino Kaku Gothic Pro, Osaka, メイリオ, Meiryo, ＭＳ Ｐゴシック, MS PGothic, sans-serif; font-size: 25px">
            	ユニックなあなたのポートフォリオで魅力的なあなたを、
           	</b><br>
           	<b class="text-faded mb-4" style="font-family: ヒラギノ角ゴ Pro W3, Hiragino Kaku Gothic Pro, Osaka, メイリオ, Meiryo, ＭＳ Ｐゴシック, MS PGothic, sans-serif; font-size: 25px">
            	あなたの能力をアピールしたらどうでしょうか。
           	</b><br><br>
           	<b class="text-faded mb-4" style="font-family: ヒラギノ角ゴ Pro W3, Hiragino Kaku Gothic Pro, Osaka, メイリオ, Meiryo, ＭＳ Ｐゴシック, MS PGothic, sans-serif; font-size: 25px">
           		あなただけのキャリア設計、<span style="color: yellow;">palatte</span>と一緒に描きましょう。
           	</b>
            <br>
            <a class="btn btn-light btn-xl js-scroll-trigger" style="margin-top: 30px;" href="userinfo/login_register">Get Started!</a>
          </div>
        </div>
      </div>
    </section>
