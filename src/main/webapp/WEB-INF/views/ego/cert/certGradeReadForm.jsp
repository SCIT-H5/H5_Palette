            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(checkImageType(data)){ 
                        str = "<div><a href='${path}/h5/displayFile?fileName="+getImageLink(data)+"'>";
                        str += "<img src='${path}/h5/displayFile?fileName="+data+"'></a>";
                    // 일반파일이면 다운로드링크
                    } else { 
                        str = "<div><a href='${path}/h5/displayFile?fileName="+data+"'>"+getOriginalName(data)+"</a>";
                    }
                    // 삭제 버튼
...
<body>
	...
	<!-- 파일을 업로드할 영역 -->
	<form id="uploadAjax" enctype="multipart/form-data">
		<input type="file" id="upload" name="file-data">
			<!-- <input type="button" id="imgBtn" value="전송"> -->
	</form>
	<!-- 업로드된 파일 목록 -->
	<div class="uploadedList" style="border: 1px solid black;"></div>
