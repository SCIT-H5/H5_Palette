							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse"
									...
									<ul class="nav navbar-nav navbar-right">
										...
										<li class="dropdown"><a href="#" class="dropdown-toggle"data-toggle="dropdown" role="button" aria-haspopup="true">自己診?</a>
											<ul class="dropdown-menu">
												<li><a href="selfCheck/goSelfCheck">自己診?作成</a></li>
												<li><a href="selfCheck/goSelfCheck3">自己診?結果</a></li>
											</ul></li>
										</sec:authorize>
										...
										<li class="dropdown"><a href="#" class="dropdown-toggle"
											data-toggle="dropdown" role="button" aria-haspopup="true">?者さんのメニュ?</a>
											<ul class="dropdown-menu">
												<li><a href="healthRecord/goHealthRecord">診?書作成</a></li>
												<li><a href="healthRecord/goHealthRecordList">診?書リスト</a></li>
												<li><a href="prescription/goPrescription">?方箋作成</a></li>
												<li><a href="prescription/prescriptionResult">?方箋リスト</a></li>
											</ul></li>
										</sec:authorize>
										<sec:authorize access="hasRole('CUSTOMER')">
										<li class="dropdown"><a href="#" class="dropdown-toggle"
											data-toggle="dropdown" role="button" aria-haspopup="true">患者さんのメニュ?</a>
											<ul class="dropdown-menu">
												<li><a href="prescription/prescriptionIndList2">個人?方箋</a></li>
												<li><a href="healthRecord/goHealthRecordList">個人診?書</a></li>
											</ul></li>
										</sec:authorize>
				...
				<div class="col-sm-12">
					<div class="head_title text-center margin-top-80">
						...
						<c:if test="${sessionScope.customer.division == 1 }">
							<h3>${sessionScope.customer.cust_Name } ?を?迎します。</h3>
						...
						<div class="row">
							...
							<div class="col-sm-5 col-sm-push-1">
								<div class="single_about">
									...
									<p> Char Hospitalは患者さんと?者さんの架け橋になるホ?ムペ?ジです。 </p> <br>
									...
									<!-- 자가진단을 하세요 -->
									<p> Second. 自己診?を作成します。 </p>
									
									<p> Third. 遠隔診療をするために予約をします。 </p>
									
									<p> Fourth. 遠隔診療を通して?者さんから正確な診?を受けます。</p>
								...
								<div class="col-sm-6 col-xs-12">
									<div class="single_message_right_info">
										<ul class="whitetext">
											...
											<li><i class="fa fa-mobile-phone"></i> <span>原則、土日祝祭日を除く3?業日以?に返信をさせて頂きます。</span></li>
											<li><i class="fa fa-mobile-phone"></i> <span>3?業日を過ぎても返信がない場合、お問い合わせが送信出?ていないか、返信させて頂いた<br>
												メ?ルがうまく受信出?ていない可能性がございます。<br>
												迷惑メ?ルフォルダやごみ箱に振り分けられていないかご確認頂き、これでも確認出?ない
												場合は、別のメ?ルアドレスよりお問い合わせ頂くようお願い致します。</span></li>
											<li><i class="fa fa-mobile-phone"></i> <span>病院、?の情報に?しては、正確ではない場合もあります。</span></li>
								...
								<div class="col-sm-6 col-xs-12">
									<div class="single_contant_left margin-top-60">
										<form action="#" id="formid">
											...
											<div class="form-group">
												<label>メ?ル</label> <input type="email"
